...
(function() {
  ...
  var searchIndex = [
    ...
    { title: 'Permis de conduire', url: prefix + 'permis.html', keywords: 'permis licence conduire conduite categorie am a1 a b c d eb ec ed 14 ans 16 ans 18 ans 21 ans age moto motocycle cyclomoteur scooter 50 125 poids lourd camion autobus narsa auto-ecole autoecole code de la route loi 52-05 116-14 decret 2-10-311 arrete 1673-18 tarif prix dhs formation theorique pratique examen questions darija amazigh points probatoire 20 30 points recuperation stage securite routiere certificat medical contrat formation referenceweb reference web duplicata renouvellement validite 10 ans etranger portugal echange permis international timbres tresorerie al barid bank barid cash amende 148 sans permis arnaque frais caches feuille de suivi heures supplementaires roi rentabilite salaire chauffeur equivalence article 8 roadmap feuille de route bateau plaisance jet ski marine marchande isem stcw capitaine avion pilote ppl cpl atpl aviation civile aiac dgac permis maritime aerien mer ciel auto ecole plateau circulation 2100 permi motor sanf cylindree 46 reforme 50cc touring club permis international consulat mre echange conversion accord bilateral teleservices separation code conduite six tentatives socle abc' },
